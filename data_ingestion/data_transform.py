...
class data_converter:
    def __init__(self):
        print("data converter class has been init...") 
        self.product_data = pd.read_csv(r"E:\\2025\\Generative_AI\\Course\\Projects\\customer_support_system\\data\\flipkart_product_review.csv")
